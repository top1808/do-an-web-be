...
const ReceivedOrderEmailTemplate = (data) => {
    return `<html>
    <head>
    <style>
     a.btn-primary {
                  ...
                  <tbody>
                    <tr>
                      <td valign="top" width="100">
                        ...
                        <p>Cảm ơn quý khách đã tin tưởng và mua hàng tại T&T Shop!</p>
                        <p>Chúng tôi rất trân trọng sự ủng hộ của quý khách và mong rằng quý khách hài lòng với sản phẩm cũng như dịch vụ của chúng tôi.</p>
                        <p>Nếu quý khách có bất kỳ thắc mắc hay góp ý nào, xin vui lòng liên hệ với chúng tôi để được hỗ trợ kịp thời.</p>
                        <p>Một lần nữa, xin cảm ơn và chúc quý khách một ngày tốt lành!</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
module.exports = ReceivedOrderEmailTemplate;