const { formatDateTimeStringRender, customMoney, formatDateStringRender } = require("../../utils/functionHelper");

const DeliveringOrderTemplate = (data) => {
    return `<html>
<body>
                  ...
                  <tbody>
                    <tr>
                      <td valign="top" width="100">
                        ...
                        <p>Ngày giao hàng: <span style="font-size:18px;font-weight:bold">${formatDateStringRender(data?.deliveryDate)}</span></p>
                        <p>Ngày dự kiến nhận hàng: <span style="font-size:18px;font-weight:bold">${formatDateStringRender(data?.receivedDate)}</span></p>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
module.exports = DeliveringOrderTemplate;