...
const CancelOrderTemplate = (data) => {
    return `<html>
<body>
                  ...
                  <tbody>
                    <tr>
                      <td valign="top" width="100">
                        ...
                        <p>Lý do hủy đơn hàng: <span style="font-size:18px;font-weight:bold">${data?.reasonCancel} </span></p>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
module.exports = CancelOrderTemplate;